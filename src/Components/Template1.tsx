...
export default function Template1() {
    ...
    return (
        <>
            <div className="m-6 max-w-[700px] item mt-[-14rem] mb-[-16rem]">
            ...
            <div className="mt-6 flex items-center justify-center">
                <button onClick={generatePdf} className="bg-blue-500 rounded-md p-2 mb-6 text-white font-semibold">{`Download`}</button>
            </div>
        </>
    )
}
