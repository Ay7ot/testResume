...
export default function Template1() {
    ...
    return (
        <div className="m-6">
            ...
            <div className='flex max-w-[700px] justify-between rounded-md min-h-[1030px] bg-[#f4f5fd]' ref={itemref}>
            ...
            <div className="mt-6 flex items-center justify-center">
                <button onClick={generatePdf} className="bg-blue-500 rounded-md p-2 mb-6 text-white font-semibold">{`textState`}</button>
            </div>
        </div>
    )
}
